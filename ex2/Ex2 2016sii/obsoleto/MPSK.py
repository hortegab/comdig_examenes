...
# Title: Mpsk
# Generated: Mon Dec 12 05:55:39 2016
##################################################
...
class MPSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0_0, 0), (self.b_Raised_cosine_0, 0))    
    ...
    def set_Fs_uz(self, Fs_uz):
        ...
        self.b_Raised_cosine_0.set_samp_rate(self.Fs_uz)
