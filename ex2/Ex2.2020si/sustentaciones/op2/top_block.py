...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Connections
        ##################################################
        self.connect((self.E3TRadio_Zero_Order_Hold_0, 0), (self.epy_block_0, 0))
        self.connect((self.E3TRadio_Zero_Order_Hold_0, 0), (self.qtgui_time_sink_x_0_0_0, 1))
        ...
        self.connect((self.blocks_int_to_float_0, 0), (self.E3TRadio_Zero_Order_Hold_0, 0))
