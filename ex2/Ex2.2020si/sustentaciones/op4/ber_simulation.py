...
class ber_simulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.samp_rate = samp_rate = 4.8e3
        self.Sps = Sps = 48
        ...
        self.Retardo_Timing = Retardo_Timing = 3
        self.Rb = Rb = Rs*Bps
        ...
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._Retardo_Timing_range = Range(0, Sps-1, 1, 3, 200)
        ...
        labels = ['T4 (Re)', 'T4 (Im)', 'R4 (Re)', 'R4 (Im)', '',
            '', '', '', '', '']
        widths = [3, 3, 3, 3, 1,
            1, 1, 1, 1, 1]
        colors = ['blue', 'red', 'green', 'black', 'cyan',
        ...
        self.analog_random_source_x = blocks.vector_source_b(list(map(int, numpy.random.randint(0, M, 10000000))), True)
        ...
        # Connections
        ##################################################
        self.connect((self.E3TRadio_diezmador_cc_0, 0), (self.b_PSD_c_0, 0))
        ...
        self.connect((self.E3TRadio_diezmador_cc_0, 0), (self.qtgui_time_sink_x_0_0_0, 1))
        ...
        self.connect((self.digital_chunks_to_symbols_xx, 0), (self.b_PSD_c_0_0, 0))
        ...
        self.connect((self.digital_chunks_to_symbols_xx, 0), (self.qtgui_time_sink_x_0_0_0, 0))
