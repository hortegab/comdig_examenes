...
# Generated: Wed Aug  2 00:37:44 2017
##################################################
...
class z_OFDM_Multiusuario(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.digital_diff_encoder_bb_0_0_0 = digital.diff_encoder_bb(M)
        self.digital_diff_encoder_bb_0_0 = digital.diff_encoder_bb(M)
        self.digital_diff_encoder_bb_0 = digital.diff_encoder_bb(M)
        self.digital_chunks_to_symbols_xx_0_0_0 = digital.chunks_to_symbols_bc((Constelacion), 1)
        ...
        self.blocks_file_source_0_0_0 = blocks.file_source(gr.sizeof_char*1, "/home/comdig1/Dropbox/EnUbuntuFull/ClaseComDig/LibroAplicativos/capitulo 3/ExSI2017.Repeticion/solucion/texto3.txt", True)
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_char*1, "/home/comdig1/Dropbox/EnUbuntuFull/ClaseComDig/LibroAplicativos/capitulo 3/ExSI2017.Repeticion/solucion/texto2.txt", True)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, "/home/comdig1/Dropbox/EnUbuntuFull/ClaseComDig/LibroAplicativos/capitulo 3/ExSI2017.Repeticion/solucion/texto1.txt", True)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.b_PCM_Encoder_Bb_0_0_0 = b_PCM_Encoder_Bb(
            code=code,
            payload=payload,
        )
        ...
        self.b_M_PAM_bb_0_0_0 = b_M_PAM_bb(
            M=M,
            Nbps=8,
        )
        ...
        self.connect((self.b_M_PAM_bb_0_0_0, 0), (self.digital_diff_encoder_bb_0_0_0, 0))    
        self.connect((self.b_PCM_Encoder_Bb_0, 0), (self.b_M_PAM_bb_0, 0))    
        self.connect((self.b_PCM_Encoder_Bb_0_0, 0), (self.b_M_PAM_bb_0_0, 0))    
        self.connect((self.b_PCM_Encoder_Bb_0_0_0, 0), (self.b_M_PAM_bb_0_0_0, 0))    
        ...
        self.connect((self.blocks_file_source_0_0_0, 0), (self.b_PCM_Encoder_Bb_0_0_0, 0))    
        ...
        self.connect((self.blocks_null_source_0, 1), (self.blocks_streams_to_vector_0, 30))    
        self.connect((self.blocks_null_source_0, 10), (self.blocks_streams_to_vector_0, 10))    
        self.connect((self.blocks_null_source_0, 11), (self.blocks_streams_to_vector_0, 11))    
        self.connect((self.blocks_null_source_0, 12), (self.blocks_streams_to_vector_0, 12))    
        self.connect((self.blocks_null_source_0, 13), (self.blocks_streams_to_vector_0, 13))    
        self.connect((self.blocks_null_source_0, 14), (self.blocks_streams_to_vector_0, 14))    
        self.connect((self.blocks_null_source_0, 15), (self.blocks_streams_to_vector_0, 15))    
        self.connect((self.blocks_null_source_0, 16), (self.blocks_streams_to_vector_0, 24))    
        self.connect((self.blocks_null_source_0, 17), (self.blocks_streams_to_vector_0, 25))    
        self.connect((self.blocks_null_source_0, 18), (self.blocks_streams_to_vector_0, 26))    
        self.connect((self.blocks_null_source_0, 19), (self.blocks_streams_to_vector_0, 27))    
        self.connect((self.blocks_null_source_0, 2), (self.blocks_streams_to_vector_0, 2))    
        self.connect((self.blocks_null_source_0, 20), (self.blocks_streams_to_vector_0, 28))    
        self.connect((self.blocks_null_source_0, 21), (self.blocks_streams_to_vector_0, 29))    
        self.connect((self.blocks_null_source_0, 22), (self.blocks_streams_to_vector_0, 16))    
        self.connect((self.blocks_null_source_0, 3), (self.blocks_streams_to_vector_0, 3))    
        self.connect((self.blocks_null_source_0, 4), (self.blocks_streams_to_vector_0, 4))    
        self.connect((self.blocks_null_source_0, 5), (self.blocks_streams_to_vector_0, 5))    
        self.connect((self.blocks_null_source_0, 6), (self.blocks_streams_to_vector_0, 6))    
        self.connect((self.blocks_null_source_0, 7), (self.blocks_streams_to_vector_0, 7))    
        self.connect((self.blocks_null_source_0, 8), (self.blocks_streams_to_vector_0, 8))    
        self.connect((self.blocks_null_source_0, 9), (self.blocks_streams_to_vector_0, 9))    
        self.connect((self.blocks_stream_to_streams_0, 0), (self.blocks_streams_to_vector_0, 17))    
        self.connect((self.blocks_stream_to_streams_0, 1), (self.blocks_streams_to_vector_0, 18))    
        self.connect((self.blocks_stream_to_streams_0, 2), (self.blocks_streams_to_vector_0, 19))    
        self.connect((self.blocks_stream_to_streams_0, 3), (self.blocks_streams_to_vector_0, 20))    
        self.connect((self.blocks_stream_to_streams_0, 4), (self.blocks_streams_to_vector_0, 21))    
        self.connect((self.blocks_stream_to_streams_0, 5), (self.blocks_streams_to_vector_0, 22))    
        self.connect((self.blocks_stream_to_streams_0, 6), (self.blocks_streams_to_vector_0, 23))    
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0_0, 0), (self.blocks_streams_to_vector_0, 1))    
        self.connect((self.digital_chunks_to_symbols_xx_0_0_0, 0), (self.blocks_streams_to_vector_0, 31))    
    ...
    def set_code(self, code):
        self.code = code
        self.set_NbpCode(len(self.code)/8.+10.)
        self.b_PCM_Encoder_Bb_0.set_code(self.code)
        self.b_PCM_Encoder_Bb_0_0.set_code(self.code)
        self.b_PCM_Encoder_Bb_0_0_0.set_code(self.code)

    def get_Tbi_c1(self):
        return self.Tbi_c1

    def set_Tbi_c1(self, Tbi_c1):
        self.Tbi_c1 = Tbi_c1
        self.set_Rbi_c1(1/self.Tbi_c1)
    ...
    def set_Constelacion(self, Constelacion):
        ...
        self.digital_chunks_to_symbols_xx_0_0_0.set_symbol_table((self.Constelacion))
    ...
    def set_payload(self, payload):
        ...
        self.set_Rb_c1(self.Rbi_c1*(1+self.NbpCode/self.payload))
        self.b_PCM_Encoder_Bb_0.set_payload(self.payload)
        self.b_PCM_Encoder_Bb_0_0.set_payload(self.payload)
        self.b_PCM_Encoder_Bb_0_0_0.set_payload(self.payload)

    def get_Rbi_c1(self):
        return self.Rbi_c1

    def set_Rbi_c1(self, Rbi_c1):
        self.Rbi_c1 = Rbi_c1
        self.set_Rb_c1(self.Rbi_c1*(1+self.NbpCode/self.payload))
    ...
    def set_M(self, M):
        ...
        self.b_M_PAM_bb_0_0_0.set_M(self.M)
    ...
    def set_N(self, N):
        ...
        self.set_N_c1(self.N/4-1)
        self.set_Nnou(self.N - self.N_c1 - self.N_c2 - self.N_c3)
    ...
    def set_N_c1(self, N_c1):
        self.N_c1 = N_c1
        self.set_Nnou(self.N - self.N_c1 - self.N_c2 - self.N_c3)
        self.set_Pt_subp(self.Pusrp/(self.N_c1+self.N_c2+self.N_c3))
        self.set_Rs(self.Rs_c1/self.N_c1)
    ...
    def set_Rs(self, Rs):
        self.Rs = Rs
        self.set_B(self.Rs*self.N)
        self.set_Es(self.Pr_subp/self.Rs)

    def get_Pusrp(self):
        return self.Pusrp

    def set_Pusrp(self, Pusrp):
        self.Pusrp = Pusrp
        self.set_Pt_subp(self.Pusrp/(self.N_c1+self.N_c2+self.N_c3))
    ...
    def set_lfs(self, lfs):
        self.lfs = lfs
        self.set_Pr_subp(self.Pt_subp/self.lfs)
    ...
    def set_B(self, B):
        self.B = B
        self.set_samp_rate_d(int(self.B))
    ...
    def set_W(self, W):
        self.W = W
        self.set_BW_RCC(self.W*(1+self.Rolloff))
    ...
    def set_Es(self, Es):
        self.Es = Es
        self.set_Es_dB(10*math.log(self.Es, 10))
    ...
    def set_No_dB(self, No_dB):
        self.No_dB = No_dB
        self.set_Es_No_dB(self.Es_dB-self.No_dB)
